...
class Polls_List_Table extends WP_List_Table {
	...
	public function add_or_edit_polls( $data, $id = null, $ays_change_type = "" ) {
		...
		if (isset($data["poll_action"]) && wp_verify_nonce($data["poll_action"], 'poll_action')) {
			...
			$poll_title_text_transform = ( isset($data['ays_poll_title_text_transform']) && $data['ays_poll_title_text_transform'] != "" ) ? sanitize_text_field($data['ays_poll_title_text_transform']) : "none";
			...
			$styles = json_encode(array(
				...
				'poll_title_text_transform'         => $poll_title_text_transform,
				// Text type options
