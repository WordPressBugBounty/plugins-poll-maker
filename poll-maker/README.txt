...
= 6.4.9 ( Sep 15, 2026 ) =
* Added: With/Without Description filter to the Poll Categories list table
...
= 6.4.7 ( Aug 26, 2026 ) =
* Added: Title text transform option in the Styles tab
* Updated: POT file
...
= 6.4.4 ( Jul 21, 2026 ) =
* Added: Current Poll Author Registered message variable on the general settings
* Tested: Compatible up to WordPress 7.0.2

= 6.4.3 ( Jul 17, 2026 ) =
* Improved: Some changes on the admin dashboard
* Fixed: Some issues on the public page
* Tested: Compatible up to WordPress 7.0.1

= 6.4.2 ( Jul 08, 2026 ) =
* Added: Instagram social media link
...
= 6.3.9 ( Jun 10, 2026 ) =
* Added: Poll Categories shortcode
* Added: Show votes count per answer before voting option 

= 6.3.8 ( May 22, 2026 ) =
* Improved: User information request handling for poll autofill
...
= 6.2.8 ( March 17, 2026 ) =
* Added: Current Poll author nickname message variable on the general settings
* Updated: Spanish language translations
* Updated: German language translations
* Updated: Turkish language translations
...
= 6.2.5 ( February 24, 2026 ) =
* Improved: Some changes on the admin dashboard

= 6.2.4 ( February 17, 2026 ) =
* Improved: Some changes on the admin dashboard
* Updated: POT and Po files

= 6.2.3 ( February 11, 2026 ) =
* Added: Poll ID message variable on the general settings
...
= 6.0.2 ( September 23, 2025 ) =
* Improved: The banner style on the admin dashboard

= 6.0.1 ( September 16, 2025 ) =
* Added: Post Author Last name message variable on the general settings
* Improved: Some changes on the admin dashboard
...
= 5.7.5 =
* Changed: Subtitle icon on the Polls List Table
* Improved: Some styles on the admin dashboard
...
= 5.7.2 =
* Added: Some sanitizing checks on the admin dashboard
* Fixed: Some RTL styles issues on the admin dashboard

= 5.7.1 =
* Added: Some sanitizing checks on the front end
* Fixed: Issue with the Elementor Plugin
...
= 5.6.7 =
* Added: Buttons width mobile option in admin dashboard

= 5.6.6 =
* Fixed: Vulnerability issue connected to the poll results list table

= 5.6.5 =
* Added: Display of answer images in public page

= 5.6.4 =
* Fixed: Vote reason displaying issue on results page
* Fixed: Code correction for Live Preview mode

= 5.6.3 =
* Fixed: Some responsive styles on the admin dashboard

= 5.6.2 =
* Improved: Some styles on the admin dashboard

= 5.6.1 =
* Added: Answer hover color option
* Improved: Some styles on the admin dashboard
...
= 5.5.9 =
* Fixed: Responsive issue on the admin dashboard
* Added: Mobile Single Column View option in admin dashboard

= 5.5.8 =
* Fixed: Styling problem on the Gutenberg page

= 5.5.7 =
* Fixed: Issue connected to the poll deactivation
* Improved: Some styles on the admin dashboard
...
= 5.5.5 =
* Fixed: Security issues on the admin dashboard and frontend
...
= 5.5.0 =
* Added: Poll title alignment on mobile option

= 5.4.9 =
* Added: Results bar in RGBA option for the Quick Poll Popup
* Fixed: Security issue connected to the poll custom answer
